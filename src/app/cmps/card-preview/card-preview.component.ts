...
// this.currCard.dragPosition = { x: locX - this.cardPreview.nativeElement.getBoundingClientRect().left - this.boardPos.left, y: locY - this.cardPreview.nativeElement.getBoundingClientRect().top - this.boardPos.top };
